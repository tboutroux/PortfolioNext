...
const ParcoursItem: React.FC<PassionItemProps> = ({ id, date, entreprise, poste }) => {
    return (
        <div id={id} className="flex justify-between items-center gap-8 bg-gray-900 py-5 px-10 lg:py-7 lg:px-16 xl:py-10 xl:px-20  rounded-xl w-full shadow-xl cursor-pointer hover:tracking-wide hover:bg-gray-950 transition-all duration-300 parcours-item">
